package com.lcsk42.starter.apidoc.handler;

import com.fasterxml.jackson.databind.type.CollectionType;
import com.fasterxml.jackson.databind.type.SimpleType;
import com.lcsk42.starter.apidoc.util.ApiDocUtil;
...
public class BaseEnumParameterHandler implements ParameterCustomizer, PropertyCustomizer {
    ...
    private String appendEnumDescription(String originalDescription, Class<?> enumClass) {
        return originalDescription + "<span style='color:red'>" + ApiDocUtil.getDescMap(enumClass) + "</span>";
    }
